...
let me = {firstName: 'Stephen', state: 'Utah', age: 31, 
...
let total = myNumbers.reduce((acc, cv) => acc + cv);
...
myNumbers.forEach(function(el, index, arr){
...
const forTheLoveOfGeorge = notGeorge.map(str => "George");
...
const totallyAwesome = people.reduce(function(acc, el, i, arr){
